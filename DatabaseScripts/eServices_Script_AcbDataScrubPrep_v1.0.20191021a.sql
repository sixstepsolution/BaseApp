--USE [Siyakhokha]
--GO
--/****** Object:  StoredProcedure [dbo].[pr_SCRIPT_AcbDataScrubPrep]    Script Date: 10/22/2019 5:43:26 PM ******/
--SET ANSI_NULLS ON
--GO
...
--            SAVE TRANSACTION pr_SCRIPT_AcbDataScrubPrep;			
			...
			SET @StrikeDay = 0;				-- ********************* change here to run script for a strike day *********************
			...
			WHERE 
				do.IsActive = 1 AND do.IsDeleted = 0 AND do.IsBatch = 0 AND dos.StatusId = @PenId
				AND do.StrikeDay = @StrikeDay;
