...
! function ($) {
    ...
    BootstrapTable.prototype.initToolbar = function () {
        ...
        if (typeof this.options.toolbar === 'string') {
            $(sprintf('<div class="bars pull-right"></div>', this.options.toolbarAlign))
    ...
    BootstrapTable.prototype.initServer = function (silent, query) {
        //change added to script - when init hit it will always take text from search box
        //instead of init searchText to null
        //was searchText: this.searchText
        var $searchVal = this.$toolbar.find('.search input').val();
